<?php
include "../../config.php";
$sql = "SELECT count(*) as total FROM agrupacion_escolar WHERE estado_agrupacion='VIGENTE';";
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var source =
            {
                url: 'php/json/establecimiento/lista_agrupaciones.php',
                datatype: "json",
                root: 'Rows',
                datafields:
                    [
        ...
        $("#grid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Establecimiento', datafield: 'establecimiento',filtertype: 'checkedlist', width: 250},
                    { text: 'Tipo', datafield: 'tipo',filtertype: 'checkedlist', width: 250},
                    { text: 'Vencimiento', datafield: 'hasta'},
        ...
        //graficos
        loadGRafico_agrupaciones_comuna();
        loadGRafico_total_agrupaciones();
    ...
    function loadGRafico_agrupaciones_comuna(){
        $.post('php/graficos/agrupaciones_comuna.php',$("#form_grafico1").serialize(),function(data){
            if(data !== 'ERROR_SQL'){
                $("#grafico1").html(data);
            }
        });
    }
    function loadGRafico_total_agrupaciones(){
        $.post('php/graficos/total_agrupaciones.php',$("#form_grafico2").serialize(),function(data){
            if(data !== 'ERROR_SQL'){
                $("#grafico2").html(data);
            }
        });
...
<div class="card-panel">
    <div class="row">
        ...
        <div class="col l8">
            <label>Total Agrupaciones Vigentes: <strong><?php echo $total_doc; ?></strong></label>
        </div>
    </div>
</div>
<div class="card-panel">
