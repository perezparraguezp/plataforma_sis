...
<div class=" card-panel">
    <form class="col l12" id="form_newPersonal">
        <div class="row">
            ...
            <p class="left">
                Formulario creado para registrar personal de la salud.
            </p>
        </div>
        <hr />
        ...
        <div class="row">
            <div class="col l6">
                <a href="#!" onclick="loadGrid_Personal()" class="btn  red darken-4 col s12"> CANCELAR REGISTRO</a>
            </div>
            <div class="col l6">
                <a href="#!" onclick="insertPersonalEstablecimiento()" class="btn waves-effect waves-light  col s12"> REGISTRAR PROFESIONAL</a>
            </div>
...
<script type="text/javascript">
    ...
    function insertPersonalEstablecimiento() {
        $.post('php/db/insert/personal.php',$("#form_newPersonal").serialize(),
            function (data) {
                if(data !== 'ERROR_SQL'){
                    loadGrid_Personal();
                }
