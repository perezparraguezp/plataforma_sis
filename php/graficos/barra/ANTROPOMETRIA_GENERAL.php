...
$sql_column = '';
$sql_column .= ",sum(antropometria.$indicador='$estado' $pendiente and $filtro_edad) as total_indicador";
$sql_column .= ",sum(antropometria.$indicador='$estado' $pendiente and persona.sexo='M' and  $filtro_edad) as total_hombres";
$sql_column .= ",sum(antropometria.$indicador='$estado' $pendiente and persona.sexo='F' and $filtro_edad) as total_mujeres";
...
if($comunal==true){
    ...
    $series .=" \n{ dataField: 'GENERAL', displayText: '$estado',labels: {visible: true,verticalAlignment: 'top',offset: { x: 0, y: -20 } },formatFunction: function (value) {return value + ' %';} ,total_general:$total,total_indicador:$porcentaje_indicador,hombres:$total_hombres,mujeres:$total_mujeres},";
    ...
    while($row2 = mysql_fetch_array($res2)){
        ...
        $json .= '{ "IR":"'.$persona->rut.'", "RUT":"'.$persona->rut.'","NOMBRE":"'.$persona->nombre.'","EDAD":"'.$persona->edad.'","COMUNAL":"'.$row2['nombre_sector_comunal'].'","ESTABLECIMIENTO":"'.$row2['nombre_centro_interno'].'","SECTOR_INTERNO":"'.$row2['nombre_sector_interno'].'","INDICADOR":"'.$persona->getAntropometria($indicador).'"}';
...
<div>
    <div class="row">
        <div class="col l4 m12 s12">
            ...
            <div id='chart_cobertura'
                 ...
                 style="width:400px; height:400px; position: relative; left: 0px; top: 0px;"></div>
        </div>
        <div class="col l8 m12 s12" style="margin-top: 55px;">
            <!-- GRAFICO DE BARRAS -->
            <div class="row">
    ...
    <div class="row hide-on-small-only">
        <div class="card">
            ...
            <hr class="row" />
            <div class="row">
                <div class="col l12 m12 s12" style="padding: 10px;padding-left: 20px;">
