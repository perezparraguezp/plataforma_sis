            ...
            <div class="nav-wrapper">
                <div class="col s12">
                    ...
                    <ul class="right hide-on-med-and-down">
                        <li onclick="load_estadistica_REMP5()"><a href="#"><i class="mdi-action-assignment-turned-in left"></i>REM P5</a></li>
...
<script type="text/javascript">
    load_estadistica_REMP5();

    function load_estadistica_REMP5() {
