...
<head>
    ...
    <title>Bienvenido - LISTADO DE PENDIENTES</title>
...
<body onload="menuEhOpen('pendientes');init();">
...
<div id="main">
    ...
    <div class="wrapper">
        ...
        <section id="content">
            <!--start container-->
            <div class="container">
                <?php include 'php/menu/pendientes_globales.php';?>
            </div>
            <!--end container-->
        </section>
        <!-- END CONTENT -->
