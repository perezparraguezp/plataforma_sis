...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadMenu_default(menu,php,rut) {
...
<body onload="loadMenu_default('menu_0','dashboard','');init();">
...
<footer class="page-footer">
    <div class="footer-copyright grey lighten-2 black-text">
        <div class="container">
            ...
            <span class="right">
            <a class="light-blue-text" href="http://www.eh-open.cl">
                <img src="logo_salud.png" alt="materialize logo" height="40" />
            </a>
        </span>
        </div>
    </div>
