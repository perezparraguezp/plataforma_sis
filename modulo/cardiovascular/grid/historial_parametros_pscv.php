            ...
            <div class="col l1">
                ...
                if($persona->myID==$row1['id_profesional']){
                    ...
                    <i class="mdi-action-delete red-text"
                       onclick="deleteHistorial('historial_parametros_pscv','<?php echo $row1['id_historial']; ?>','<?php echo $rut; ?>')"
...
<script type="text/javascript">
    ...
    function deleteHistorial(table,id,rut) {
        if(confirm('DESEA ELIMINAR ESTE REGISTRO')){
            $.post('db/delete/historial.php',{
                ...
                if(data!=='ERROR_SQL'){
                    ...
                    loadHistorialParametroPSCV(rut,'<?php echo $indicador ?>')
                }
            });
        }
    }
