    ...
    <div class="row">
        <div class="col l4 m6 s12">
            ...
            <select name="indicador" id="indicador">
                ...
                <option value="paciente_pscv">FACTOR DE RIESGO</option>
                <option value="paciente_pscv">PATOLOGIAS</option>
                <option value="paciente_pscv">TRATAMIENTO</option>
                <option value="paciente_pscv">PACIENTES DEPENDIENTES</option>
    ...
    <div class="row" style="margin-top: 5px;">
        <div class="col l12 m12 s12">
            <input type="button"
                   ...
                   value="CARGAR GRAFICO" onclick="loadGrafico_PSCV()" />
        </div>
    </div>
</div>
