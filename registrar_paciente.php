...
<head>
    ...
    <title>Bienvenido - Atencón General</title>
    ...
    <link href="jqwidgets/styles/sle.css" type="text/css" />
...
<body onload="menuEhOpen('registrar_paciente');init();">
...
<!-- START MAIN -->
<div id="mai<?php include 'php/html/script.php';  ?>n">
    <!-- START WRAPPER -->
    <div class="wrapper">
        ...
        <section id="content">
            <!--start container-->
            <div class="container">
                <?php include 'php/menu/registro_paciente.php';?>
            </div>
            <!--end container-->
        </section>
        <!-- END CONTENT -->
