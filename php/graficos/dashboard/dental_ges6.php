...
$sql1 = "select nombre_centro_interno,nombre_sector_interno,ges6,cero,count(*) as total,sum(upper(ges6)='SI') as total_ges6
from persona
    ...
    $(document).ready(function () {
        function diplayDentalGes6() {
            ...
            for (var i = 0; i < metrics.length; i++) {
                ...
                $("#dental_ges").append("<div id='dental_ges"+i+"' style='width: 400px; height: 180px;'></div>");
                ...
                var selector = '#dental_ges'+ (i).toString();
