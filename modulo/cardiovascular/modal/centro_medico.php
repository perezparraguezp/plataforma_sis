...
<script type="text/javascript">
    ...
    function updateDatosEstablecimiento() {
        if(confirm('DESEA ACTUALIZAR ESTA INFORMACIÓN')){
            $.post('db/update/establecimiento.php',
    ...
    function deleteSectorInterno(id) {
        if(confirm('DESEA ELIMINAR ESTE SECTOR')){
            $.post('db/delete/sector_centro_interno.php',
                {id:id}
                ,function (data) {
                    alertaLateral(data);
                    loadListaSectoresInternos();
    ...
    function insertSectorInterno(){
        $.post('db/insert/sector_centro_interno.php',
    ...
    function loadListaSectoresInternos() {
        var source =
            {
                url: 'json/lista_sectores_internos.php?id_centro_interno=<?php echo $id_centro_interno; ?>',
                datatype: "json",
                root: 'Rows',
                datafields:
                    [
